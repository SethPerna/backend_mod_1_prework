...
puts "In a predictable result, the #{slow_poke} best the #{speedy}!"
...
wife = "Jacey"
son = "Levon"
dogs = "Penelope and Lily"

puts "I love spending days with my fiance #{wife}, my son #{son} and our two dogs #{dogs}."
